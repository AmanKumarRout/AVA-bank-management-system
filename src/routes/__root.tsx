...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Nexus Bank — Modern Banking Management" },
      ...
      { property: "og:title", content: "Nexus Bank — Modern Banking Management" },
      { name: "twitter:title", content: "Nexus Bank — Modern Banking Management" },
